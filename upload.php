        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg  hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="profile-tab"
            ...
            <div class=" p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
                ...
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-12">
                        ...
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Please upload your product files (in JSON format) for batch addition.</p>
                    </div>
                            ...
                            <div class="p-2 w-full">
                                <div class="relative">
                                    <label for="productsFile"
                                        class="leading-7 text-sm text-gray-600">Select commodity file (JSON format):</label>
